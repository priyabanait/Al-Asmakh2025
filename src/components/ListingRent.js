            ...
            >
              ...
              <div className="pt-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-[#001730] text-white text-sm font-semibold px-4 py-2 rounded flex items-center gap-2 transition hover:bg-[#1b3a70]">
                    <span>Details</span>
              ...
              >
                ...
                <div className="pt-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-[#001730] text-white text-sm font-medium px-5 py-2 rounded-md flex items-center justify-between gap-2 shadow-lg transition-all duration-300 hover:bg-[#002d52]">
                      <span>Details</span>
