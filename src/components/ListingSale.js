      ...
      <section className="relative w-full min-h-[80vh] lg:min-h-[80vh] flex flex-col items-center justify-center overflow-visible">
        ...
        <div className="absolute left-1/2 bottom-0 mb-5 transform -translate-x-1/2 translate-y-1/2 z-20 w-[90%] lg:hidden">
          <div className="space-y-3">
            ...
            <div className="w-[100%] h-[0.5px] bg-gray-300 my-2 mb-4  px-10"></div>
          </div>
        </div>
 ...
 font-medium shadow  transition text-[#001730]">
          ...
          {properties.map((property, index) => (
            ...
            >
              ...
              <div className="pt-2">
                ...
                {/* Bed/Bath/Area Info */}
                <div className="grid grid-cols-3 gap-2 text-[#001730] text-sm mb-4">
          ...
          <div className="hidden lg:flex max-w-full mb-5 bg-gray-50 mx-auto items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-6 py-2 rounded-md text-base font-semibold transition-all cursor-pointer
    ${viewMode === "LIST"
                    ? "border border-white/40 backdrop-blur-md bg-[#e3e2d8]/40 text-[#001730] shadow-[0_4px_14px_rgba(0,0,0,0.15)]"
                    : "text-gray-600 hover:text-[#001730] hover:bg-gray-100"
                  }`}
              >
                <FaList size={14} />
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-6 py-2 rounded-md text-base font-semibold transition-all cursor-pointer ${viewMode === "MAP"
                  ? "border border-white/40 backdrop-blur-md bg-[#e3e2d8]/40 text-[#001730] shadow-[0_4px_14px_rgba(0,0,0,0.15)]"
        ...
        {viewMode === "LIST" ? (
          ...
          >
            {properties.map((property, index) => (
              <div
                key={index}
                className="w-full p-4 bg-[#E9E9E9] border mt-6  rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300"
              >
                {/* Image Section */}
                    ...
                    <div className="flex p-4 rounded-md">
                      ...
                      <div className="flex-1 p-4 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between gap-2 mb-3">
                          <p className="text-[24px] lg:text-base font-bold text-[#001730] m-0">
                            {property.price} QAR
                          </p>
  ...
  <button className="bg-[#001730] text-white text-[12px] font-medium px-3 md:px-4 lg:px-5 xl:px-5 2xl:px-6 3xl:px-7 4xl:px-8 5xl:px-10 py-1.5  lg:py-2  rounded-md flex items-center justify-between shadow-lg transition-all duration-300 hover:bg-[#002d52]">
              ...
              <div className="mt-6 mb-4">
                <button className="w-full text-[12px] bg-[#001730] text-white py-3 rounded-md flex items-center justify-between gap-2 shadow-lg transition-all duration-300 hover:bg-[#002d52] px-8">
            ...
            <div className="hidden lg:block w-1/2 mt-6 relative bg-gray-200">
              {/* Map Container */}
