        ...
        <div className="hidden lg:flex h-[calc(100vh-120px)]">
          ...
          <div className="w-full lg:w-1/2 overflow-y-auto  bg-gray-50 p-4">
              ...
              {properties.map((property) => (
                ...
                >
                  <div className="flex p-4 rounded-md">
                    ...
                    {/* Image Section - Left */}
                    <div className="relative w-[320px] h-[208px] lg:w-[220px] lg:h-[208px] xl:w-[320px] xl:h-[192px]  flex-shrink-0">
                      <Image
                        src={property.image}
                        alt={property.title}
                        fill
            ...
            <div className="mt-6 mb-4">
              <button className="w-full bg-[#001730] text-white py-3 text-[12px] rounded-md hover:bg-[#002d52] transition-colors flex items-center justify-between px-8">
          ...
          <div className="hidden lg:block w-1/2 relative  m-4 bg-gray-200">
            {/* Map Container */}
